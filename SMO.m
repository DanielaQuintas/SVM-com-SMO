    ...
    hold on
    legend({'-1:Outras Espécies ','+1:Iris Versicolor '});
    title('Dataset Iris');
    axis equal
    hold off 
   ...
   %---- gráfico  do data set de treino 
    ...
    if ~flag
       legend(h,{'-1:Outras Especies-treino','+1:Versicolor-treino','Vetores Suporte'});    
    else  
       legend(h,{'-1:Outras Espécies-treino','+1:Versicolor-treino','Vetores Suporte', '-1:Outras Espécies-validação','+1:Versicolor-validação'});
